...
__host__ double expectation_dV_dx(trap_geo params,
    ...
    dVdx[0][0] = 0.5*muB*gs * make_cuDoubleComplex(dBdx.z,
                                                   0.);
    dVdx[0][1] = 0.5*muB*gs * make_cuDoubleComplex(dBdx.x,
                                                   -dBdx.y);
    dVdx[1][0] = 0.5*muB*gs * make_cuDoubleComplex(dBdx.x,
                                                   dBdx.y);
    dVdx[1][1] = 0.5*muB*gs * make_cuDoubleComplex(-dBdx.z,
                                                   0.);
...
__host__ double expectation_dV_dy(trap_geo params,
    ...
    dVdy[0][0] = 0.5*muB*gs * make_cuDoubleComplex(dBdy.z,
                                                   0.);
    dVdy[0][1] = 0.5*muB*gs * make_cuDoubleComplex(dBdy.x,
                                                   -dBdy.y);
    dVdy[1][0] = 0.5*muB*gs * make_cuDoubleComplex(dBdy.x,
                                                   dBdy.y);
    dVdy[1][1] = 0.5*muB*gs * make_cuDoubleComplex(-dBdy.z,
                                                   0.);
    // Perform expectation value calculation
...
__host__ double expectation_dV_dz(trap_geo params,
    ...
    dVdz[0][0] = 0.5*muB*gs * make_cuDoubleComplex(dBdz.z,
                                                   0.);
    dVdz[0][1] = 0.5*muB*gs * make_cuDoubleComplex(dBdz.x,
                                                   -dBdz.y);
    dVdz[1][0] = 0.5*muB*gs * make_cuDoubleComplex(dBdz.x,
                                                   dBdz.y);
    dVdz[1][1] = 0.5*muB*gs * make_cuDoubleComplex(-dBdz.z,
                                                   0.);
    // Perform expectation value calculation
